...
\vspace{0.5cm}
Das Unternehmen befindet sich in der Gründungsphase, wobei der Prototyp fertiggestellt ist und die Markteinführung für den 01. Februar 2026 geplant ist.
...
Bei Abwesenheit eines Gründers übernehmen die anderen beiden dessen Aufgaben. Die technische Dokumentation ermöglicht eine schnelle Einarbeitung und kritische Zugangsdaten sind sicher bei allen Gesellschaftern hinterlegt.
...
\vspace{0.5cm}
Neue Mitarbeiter werden durch interne Einarbeitung in die Codebasis, Dokumentation aller Prozesse und Workflows sowie Pair-Programming mit erfahrenen Gründern geschult.
