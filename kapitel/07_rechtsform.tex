...
\section{Gewählte Rechtsform und Begründung}

Für den Start wurde die \textbf{GbR (Gesellschaft bürgerlichen Rechts)} als Rechtsform gewählt, wobei bei entsprechendem Wachstum eine Umwandlung in UG (haftungsbeschränkt) oder GmbH geplant ist.

Die Vorteile der GbR liegen in der einfachen Gründung ohne Notar und Handelsregistereintrag, den geringen Kosten von nur circa 30 bis 50 Euro für die Gewerbeanmeldung, dem fehlenden Erfordernis einer Mindesteinlage, der flexiblen Gestaltung durch einen frei verhandelbaren Gesellschaftsvertrag sowie der Möglichkeit zum schnellen Start innerhalb weniger Tage.

Die Nachteile sind die persönliche Haftung der Gesellschafter, die fehlende Eintragungsmöglichkeit im Handelsregister sowie eine begrenzte Außenwirkung bei Geschäftspartnern. Bei Erreichen eines nachhaltigen Wachstums ab circa 50.000 Euro Jahresumsatz ist daher die Umwandlung in eine UG (haftungsbeschränkt) oder die direkte Gründung einer GmbH vorgesehen.
...
\vspace{0.5cm}
Phillipp Atzler erhält 40 Prozent als Geschäftsführer mit erhöhter Verantwortung, während Maike Abel und Elisa Dörnbrak je 30 Prozent als gleichberechtigte Gesellschafterinnen erhalten. Diese Verteilung verhindert Pattsituationen bei Abstimmungen.
