...
\vspace{0.5cm}
\noindent Die laufenden Kosten für Hosting betragen circa 72 Euro pro Jahr und für die Domain circa 12 Euro pro Jahr, sodass der Break-Even bereits ab 10 zahlenden Nutzern erreicht wird. Die Preise orientieren sich an der Konkurrenz, wo 2 bis 5 Euro pro Monat üblich sind.
...
\vspace{0.5cm}
\noindent Das Zielgebiet ist die DACH-Region (Deutschland, Österreich, Schweiz).
...
\vspace{0.5cm}
\noindent Der Marketing-Mix ist darauf ausgelegt, virales Wachstum durch das Freemium-Modell zu ermöglichen. Zufriedene Free-User werben neue Nutzer an und das Premium-Upgrade ist innerhalb der App prominent platziert. Das Nachhaltigkeits-Thema spricht gezielt die umweltbewusste Zielgruppe an.
